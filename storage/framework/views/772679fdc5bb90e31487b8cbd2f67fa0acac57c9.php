...
<html>
    ...
    <body>
        ...
        <section class="main_piscturesDB">
            ...
            <div class="signup">Non hai un account? <a href="<?php echo e(url('signup')); ?>" class = "button">Iscriviti</a>
        </section>
        </main>
		<footer>
...
<?php /**PATH C:\Users\matti\example-app\resources\views/login.blade.php ENDPATH**/ ?>